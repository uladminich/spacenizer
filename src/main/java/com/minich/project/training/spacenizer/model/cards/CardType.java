...
public enum CardType {
    ...
    ROAD("road", "Дорога", "ДОРОГА. Увеличивает добычу кр на 1.", 1, 0),
    MINE("mine", "Шахта", "ШАХТА. Увеличивает добычу КР на 2. Увеличивает расход КР на 1.", 2, 1),
    BAR("bar", "Бар", "БАР. Уменьшает добычу КР на 1, увеличивает расход КР на 1.", -1, 1),
    LABORATORY("laboratory", "Лаборатория", "ЛАБОРАТОРИЯ. Увеличивает расход КР на 1. TODO", 0, 1),
    WASTE_RECYCLE("waste-recycle", "Переработка отходов", "ПЕРЕРАБОТКА ОТХОДОВ. Уменьшает расход КР на 1.", 0, -1);
