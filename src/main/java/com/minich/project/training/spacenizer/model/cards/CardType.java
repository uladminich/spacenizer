...
public enum CardType {
    ...
    // [end]
    // [start] global
    DANGEROUS_WORLD(9L, "dangerous-world", "Враждебная природа", "Уменьшает всю добычу на 2", -2, 0, -2, 0, 1, true),
    ICE_WORLD(10L, "ice-world", "Ледяная планета", "Увеличивает расход КР на 1, СР на 2.", 0, 1, 0, 2, 1, true),
    RICH_MINERAL_DEPOSIT(11L, "rich-mineral-deposits", "Обширные залежи ресурсов", "Увеличивает всю добычу на 1. ", 1, 0, 1, 0, 1, true), // "Карты 'Шахта' и 'Переработка отходов' приностят дополнительно по 1 КР."
    EARTHQUAKES(12L, "earthquakes", "Повышенная сейсмическая активность", "С некоторой вероятностью в конце раунда может уничтожить до 3 построек (кроме станции) в конце раунда.", 0, 0, 0, 0, 1, true); // TODO destroy station if player has no other building
    // [end]
    // [start] special
