...
public enum CardType {
    ...
    EARTHQUAKES(12L, "earthquakes", "Повышенная сейсмическая активность", "С некоторой вероятностью в конце раунда может уничтожить до 3 построек (кроме станции) в конце раунда.", 0, 0, 0, 0, 1, true);
    // [end]
    // [start] special
