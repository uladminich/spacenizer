...
public enum CardType {
    ...
    WASTE_RECYCLE(4L, "waste-recycle", "Переработка отходов", "ПЕРЕРАБОТКА ОТХОДОВ. Уменьшает расход КР на 1.", 0, -1, 0, 0, 1),
    ...
    LABORATORY(7L, "laboratory", "Лаборатория", "ЛАБОРАТОРИЯ. Увеличивает расход КР на 1. Добывает по 2 CР.", 0, 1, 2, 0, 1),
    ROBOTS(8L, "robots", "Роботизация", "РОБОТИЗАЦИЯ. Увеличивает показатели карт 'Шахта', 'Дорога', 'Переработка отходов', 'Лаборатория' в два раза.", 0, 0, 0, 0, 2),  // only one per player 
    // not implemented:
